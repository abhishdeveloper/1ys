        ...
        <div>
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="mt-1">
                        <textarea id="how_to_use" name="how_to_use" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-md p-2"></textarea>
                    </div>
                </div>
                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="mt-1">
                        <textarea id="ingredients" name="ingredients" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-md p-2"></textarea>
                    </div>
                </div>
                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="mt-1">
                        <textarea id="benefits" name="benefits" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-md p-2"></textarea>
                    </div>
                </div>
                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="flex gap-4">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="badges[]" value="Bestseller" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50">
                            <span class="ml-2">Bestseller</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="badges[]" value="New Arrival" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50">
                            <span class="ml-2">New Arrival</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="badges[]" value="Vegan" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50">
                            <span class="ml-2">Vegan</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="badges[]" value="Cruelty-Free" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <div class="sm:col-span-6 border-t border-gray-200 pt-6">
                    ...
                    <div id="faq-container" class="space-y-4">
                        <!-- Initial empty state or default one -->
                    </div>
                </div>
                ...
                <div class="sm:col-span-6 border-t border-gray-200 pt-6">
                    ...
                    <div id="variant-container" class="space-y-4">
                        <!-- Empty initially. If left empty, only the base price/stock is used. -->
                    </div>
