...
<div class="mb-32 mt-16 px-4">
    ...
    <?php if (empty($categories)): ?>
        <p class="text-gray-400 text-center font-light tracking-widest reveal-on-scroll">The collections are currently being prepared for you.</p>
    <?php else: ?>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-16 max-w-6xl mx-auto px-4 sm:px-8">
            <?php foreach ($categories as $category): ?>
                <a href="/category/<?php echo sanitize($category['slug']); ?>" class="group flex flex-col items-center text-center transition-all duration-700 hover:-translate-y-2 reveal-on-scroll" data-stagger="true">
...
<div class="mb-32 bg-[#172a20] text-secondary py-24 px-4 relative overflow-hidden border-y border-accent/30 shadow-[0_0_50px_rgba(0,0,0,0.2)]">
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8 text-center relative z-10">
        <div class="flex flex-col items-center p-4 group reveal-on-scroll" data-stagger="true">
